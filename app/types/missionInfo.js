...
const missionInfo = {
    CREATE_TODAY_SHORTPLY: {
        ...
        failureButtonAction: () => {
            window.location.href = 'poodle://deeplink/video';
        },
        deeplink: 'poodle://deeplink/video',
    },
    REPLY_5: {
        text: '댓글 5개 이상 작성하기',
    ...
    ATTENDANCE_BONUS: {
        ...
        failureButtonAction: () => {
            window.location.href = 'poodle://deeplink/home';
        },
        ...
        successButtonAction: () => {
            window.location.href = 'poodle://deeplink/wallet';
        },
        deeplink: 'poodle://deeplink/attendance',
    },
    CELPICK_VOTE_COMPLETE: {
        ...
        failureButtonAction: () => {
            window.location.href = 'poodle://deeplink/celpick';
        },
        deeplink: 'poodle://deeplink/celpick',
    },
