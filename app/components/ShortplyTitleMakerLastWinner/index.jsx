...
function ShortplyTitleMakerLastWinner({lastWinnerInfo}) {
    const goDeeplink = () => {
        window.location.href = 'poodle://deeplink/profile?nickname=' + lastWinnerInfo.nickname + ''
    }

    function goShortplyDeeplink() {
        window.location.href = 'poodle://deeplink/shortply?id=' + lastWinnerInfo.shortplyId + ''
    }
